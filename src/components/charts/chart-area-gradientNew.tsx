...
// Component for displaying sales performance graph
const SalesPerformanceGraph = () => {
  // Data for this month and last month
  ...
  // Function to scale data points for SVG rendering
  const scaleDataPoint = (value: any) => {
    const graphHeight = 120;
    return graphHeight - (value / maxValue) * graphHeight;
  };

  // Function to generate SVG path data from array of points
